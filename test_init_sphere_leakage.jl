...
println("rot_angles[1:4] (rad) : ", meta.rot_angles[1:4])
println("rot_angles[1:4] (deg) : ", rad2deg.(meta.rot_angles[1:4]))
println("center (row, col)     : ", meta.center)
println("epsilon_right         : ", meta.epsilon_right, "  (mesuré sur les données : (-9.7, +2.3))")
